 ...
 *
 * Environment is synthetic. `DATABASE_URL` / `REDIS_URL` come from CI services (or local
 * defaults); `APP_SECRET` is a fixed CI value. Nothing here reaches a production system.
 */
...
export const BASE_ENV: Record<string, string> = {
  ...
  APP_SECRET: 'ci-only-app-secret-0123456789abcdef0123456789abcdef',

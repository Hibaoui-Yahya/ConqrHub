// Applies the two test-harness edits to apps/server/package.json when the harness is overlaid
// onto another branch (workflow_dispatch): the Jest module mapper for absolute `src/` imports
